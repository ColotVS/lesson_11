public class lesson_11_35 {
    //Как известно, на планете Земля есть 6 материков.
    //Создай для каждого материка собственный класс. В каждом классе должно быть поле, которое хранит площадь соответствующего материка.
